...
public class ActionsTest {
    ...
    public void hoverTest2(){
        driver.get("http://practice.cybertekschool.com/hovers");
        WebElement img2 = driver.findElement(By.tagName("(//img)[2]"));
        Actions action = new Actions(driver);
        action.moveToElement(img2);

        WebElement viewLink = driver.findElement(By.xpath("(//*[.='View profile'])[2]"));
        Assert.assertTrue(viewLink.isDisplayed(),"verify the link is displayed");
    }
    @Test
    public void Test() throws InterruptedException {
        driver.get("http://practice.cybertekschool.com/hovers");
        WebElement img1 = driver.findElement(By.xpath("C"));
        Actions action = new Actions(driver);
    ...
    public void dragAndDrop() throws InterruptedException {
        ...
        List<WebElement> acceptAndClose = driver.findElements(By.linkText("Accept and Close"));
        ...
        Thread.sleep(2000);
        actions.dragAndDrop(source,target).perform(); //bu yol daha kolay

        //actions.moveToElement(source).clickAndHold().moveToElement(target).pause(2000).release().perform();// bunuda kullanabiliriz
